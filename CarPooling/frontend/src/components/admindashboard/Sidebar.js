...
const Sidebar = () => {
  ...
  <CSidebarNav>
    ...
    <CNavItem href="#"><CIcon customClassName="nav-icon" icon={icon.cilScreenDesktop} /> Dashboard</CNavItem>
      <CNavItem href="#"><CIcon customClassName="nav-icon" icon={icon.cilPeople} />Employees</CNavItem>
    <CNavItem href="#"><CIcon customClassName="nav-icon" icon={icon.cilMap} /> Routes</CNavItem>
